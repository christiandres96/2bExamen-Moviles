...
class EstudianteClienteAdapter(private val entrenadorList: List<Estudiante>) :  RecyclerView.Adapter<EstudianteClienteAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.detalles.setOnClickListener{
            ...
            intent.putExtra("detallesEntrenadorCliente", estudiante)
